...
export function MemberEditModal({ isOpen, onClose, memberId, onSuccess }: MemberEditModalProps) {
  ...
  useEffect(() => {
    if (!user || !memberId || !isOpen) return;
    ...
    loadMember();
  }, [user, memberId, isOpen, setValue, addToast]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-900">Editar Membro</h2>
          <button
            onClick={onClose}
